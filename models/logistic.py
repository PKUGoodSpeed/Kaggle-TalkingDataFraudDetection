...
def Shaocong(train_file, valid_file, test_file, output_dir):
    ...
    lg = LogisticRegression(C=1., random_state=17, class_weight={0:1, 1:20})
    ...
    print("Predicting...")
    test_df['pred'] = lg.predict_proba(test_df[Predictors])[:, 1]
    ...
    print("Making OOF ...")
    valid_df['pred'] = lg.predict_proba(valid_df[Predictors])[:, 1]
